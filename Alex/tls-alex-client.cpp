...
void *writerThread(void *conn)
{
	...
	{
		char ch;
		printf("Command (f=forward, b=reverse, l=turn left, r=turn right, s=stop, c=clear stats, v=colour sense, g=get stats q=exit)\n");
		scanf("%c", &ch);
...
#define privatekey "laptop.key"
#define certificate "laptop.crt"
#define certificatename "signing.pem"
#define commonname "SU1112"
/* END TODO */
void connectToServer(const char *serverName, int portNum)
{
    /* TODO: Create a new client */
	createClient(serverName, portNum, 1, certificatename, commonname, 1, certificate, privatekey, readerThread, writerThread);
    /* END TODO */
}
